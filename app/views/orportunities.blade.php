...
<div class="container ">
    <div class="two_third">
        <section class="post">
            ...
            <p>Lorem ipsum dolor sit amet, proscriptum videt ulteriori. Filiam sunt amore nec est cum autem est se in.
             ...
             <h4>Tags: &loz; <a href="#">Print</a></h4></section>
  ...
  ================================================== -->
    <div class="one_third lastcolumn sidebar">
        <section class="first">
            <h3>Orportunities Navigation</h3>
            <div class="boxtwosep"></div>
            <ul class="blogList">
                <li><a class="about" href="blog.html" title="">Blog - Style One</a></li>
                <li class="activenavigationItem">Blog - Active Item</li>
                <li><a class="about" href="singleblog.html" title="">Blog - Blog Post</a></li>
            </ul>
        </section>
