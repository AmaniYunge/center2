...
<div class="container boxthree">
   ...
   <p class="lead" style="text-align: center;font-size: 28px">Board Members</p>
    ...
    <div class="one_fourth" style="box-shadow: 5px 5px 10px #888888">
        ...
        <div class="toggle-container">
            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac
                ...
                wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui.
                Donec non enim in turpis pulvinar facilisis. Ut felis. Praesent dapibus, neque id cursus faucibus, tortor neque egestas
    ...
    <div class="one_fourth lastcolumn" style="box-shadow: 5px 5px 10px #888888">
        ...
        <div class="toggle-container">
            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac
                ...
                tortor neque egestas augue, eu vulputate magna eros eu erat. </p>
        </div>
    </div>
    <!-- one-third column ends here -->
</div>
