...
<div class="flexslider">
    <ul class="slides">
        ...
        <li> <a href="#"><img src="{{asset('images/flexslider/dot2.jpg')}}" style="height: 480px;width: 100%" alt="" /></a>
            <p class="flex-caption" >Welcome to  Nkinga Health Center  Site. This is example of the Caption Title.</p></li>
        <li> <a href="#"><img src="{{asset('images/flexslider/ifm.jpg')}}" style="height: 480px;width: 100%" alt="" /></a>
...
<div class="container boxthree">
    ...
    <div class="one_third" style="box-shadow: 5px 5px 10px #888888;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px">
        <section class="boxthreeleft"> <img src="{{asset('images/awep.jpg')}}" style="height:200px;width: 100%; box-shadow: 1px 1px 5px #888888" alt=""/>
    ...
    <div class="one_third" style="box-shadow: 5px 5px 10px #888888;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px">
        <section class="boxthreecenter"> <img src="{{asset('images/dot2.jpg')}}" style="height:200px;width: 100%; box-shadow: 1px 1px 5px #888888" alt=""/>
            <h3>Fashion Love</h3>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <a class ="simple" href="#">+ Learn more</a> </section>
    </div>
    ...
    <div class="one_third lastcolumn" style="box-shadow: 5px 5px 10px #888888;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px">
        <section class="boxthreeright"> <img src="{{asset('images/dot.jpg')}}" style="height:200px;width: 100%; box-shadow: 1px 1px 5px #888888" alt=""/>
